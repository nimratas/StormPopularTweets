...
public class Topology {
	...
	public Topology(String topologyName) throws InterruptedException {
	...
	private void wireTopology() throws InterruptedException {
		...
		builder.setBolt("LossyBucketBolt", new LossyBucketBolt(), 4).fieldsGrouping("HashTagBolt", new Fields("hashtags", "sentiScore"));
